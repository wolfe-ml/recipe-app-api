...
def detail_url(recip_id):
    """Create and return a recipe detail url"""
    return reverse('recipe:recipe-detail', args=[recip_id])
...
def create_recipe(user, **params):
    ...
    defaults = {
        ...
        'link': 'http://ecample.com/recipe.pdf'
    }
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='test@example.com', password='test123')
    ...
    def test_partial_update(self):
        ...
        original_link = 'http://ecample.com/recipe.pdf'
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'http://ecample.com/new-recipe.pdf',
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='test3@example.com', password='test123')
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient2 = Ingredient.objects.create(user=self.user, name="Lemon")
